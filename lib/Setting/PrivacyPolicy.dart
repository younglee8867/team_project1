              ...
              Text.rich(
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: '<스마트 환승철>은(는) 정보주체의 자유와 권리 보호를 위해 '.tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 13,
                        fontFamily: 'Roboto',
                    ...
                    TextSpan(
                      text: '「개인정보 보호법」및 관계 법령이 정한 바를 준수하여, '.tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 13,
                        fontFamily: 'Roboto',
                    ...
                    TextSpan(
                      text: '적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. '.tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 13,
                        fontFamily: 'Roboto',
