                    ...
                    children: [
                      ...
                      TextSpan(
                        text: '\n'+'본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)'.tr()+
                            '이 스마트 환승철(이하 “회사”라고 합니다)이 제공하는 위치정보서비스 및 위치기반서비스'.tr()+
                      ...
                      TextSpan(
                        text: '\n'+'본 약관은 서비스를 신청한 고객 또는 개인위치정보주체가 본 약관에 동의하고 회사가 정한 소정의 절차에 따라 '.tr()+
                            '서비스의 이용자로 등록함으로써 효력이 발생합니다.'.tr()+'\n'+
                            '회사는 본 약관의 내용을 회원이 쉽게 알 수 있도록 서비스 초기 화면에 게시하거나 기타의 방법으로 공지합니다.'.tr()+
                            '회사는 필요하다고 인정되면 본 약관을 변경할 수 있으며, 회사가 약관을 개정할 경우에는 기존약관과 개정약관 및 '.tr()+
                            '개정약관의 적용일자와 개정사유를 명시하여 현행약관과 함께 그 적용일자 7일 전부터 적용일 이후 상당한 기간 동안 공지합니다. '.tr()+
                            '다만, 개정 내용이 회원에게 불리한 경우에는 그 적용일자 30일 전부터 적용일 이후 상당한 기간 동안 각각 이를 서비스 홈페이지에 '.tr()+
                            '게시하거나 회원에게 전자적 형태(전자우편, SMS 등)로 약관 개정 사실을 발송하여 고지합니다.'.tr()+'\n'+
                            '회사가 전항에 따라 회원에게 공지하거나 통지하면서 공지 또는 통지ㆍ고지일로부터 개정약관 시행일 7일 후까지 거부의사를 '.tr()+
