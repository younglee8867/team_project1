              ...
              Text.rich(
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: '본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)'.tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 12,
                        fontFamily: 'Roboto',
                    ...
                    TextSpan(
                      text: '이 스마트 환승철(이하 “회사”라고 합니다)이 제공하는 위치정보서비스 및 위치기반서비스'
                          .tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 12,
                    ...
                    TextSpan(
                      text: '(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리•의무 및 책임사항을'
                          .tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 12,
                    ...
                    TextSpan(
                      text: '서비스의 이용자로 등록함으로써 효력이 발생합니다.'.tr(),
                      style: TextStyle(
                        color: Color(0xFFA0A0A0),
                        fontSize: 12,
                        fontFamily: 'Roboto',
